...
-- INSERT INTO `Heatmap_Config` (`map`, `game`, `xoffset`, `yoffset`, `flipx`, `flipy`, `days`, `brush`, `scale`, `font`, `thumbw`, `thumbh`, `cropx1`, `cropy1`, `cropx2`, `cropy2`) VALUES
...
('BroadCastEventsCommand', 'hlx_event', 'The RCON command used to broadcast events (kills, actions, etc.) to players on the game server.'),
('BroadCastEventsCommandAnnounce', 'hlx_csay', 'The RCON command used for center HUD announcements (summary stats, admin messages, etc.).'),
...
('GameEngine', '1', 'Game engine of game on this server:<UL>\r\n<LI>1 = HL1 (GoldSource).\r\n<LI>2 = HL2 (Source original).\r\n<LI>3 = HL2ep2 (Source OrangeBox).</UL>'),
...
('Mod', 'AMXX', 'Valid values are AMXX, SOURCEMOD, MINISTATS, BEETLE, and MANI if one of such plugins are installed.'),
...
('PlayerEventsCommand', 'hlx_event', 'The RCON command used to send player-specific events (rank, stats, session) to individual players.'),
('PlayerEventsCommandOSD', 'hlx_tsay', 'The RCON command used for top HUD on-screen display messages (rank, session, kpd responses).'),
...
('PlayerEventsCommandHint', 'hlx_typehud', 'The RCON command used for typewriter/hint HUD messages (auto-team balance notifications, etc.).');
