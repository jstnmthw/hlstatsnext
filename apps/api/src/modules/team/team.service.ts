...
export class TeamService {
   ...
   * Create a new team
   */
  async createTeam(input: Prisma.TeamCreateInput): Promise<Result<Team, AppError>> {
    try {
   ...
   * Update a team
   */
  async updateTeam(teamId: number, input: Prisma.TeamUpdateInput): Promise<Result<Team, AppError>> {
    try {
