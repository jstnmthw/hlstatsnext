  ...
  private async sendEventNotification(
    ...
    try {
      ...
      const killNotificationData = {
        ...
        killerSkill: (killerStats.skill || this.DEFAULT_RATING) + skillAdjustment.killerChange,
        victimSkill: (victimStats.skill || this.DEFAULT_RATING) + skillAdjustment.victimChange,
        weapon: weapon || "unknown",
        headshot: headshot || false,
        skillAdjustment,
        timestamp: new Date(),
