...
export class RoleService {
   ...
   */
  async getRoleStatistics(params: { game?: string; limit?: number }): Promise<Result<Role[], AppError>> {
    try {
   ...
   * Create a new role
   */
  async createRole(input: Prisma.RoleCreateInput): Promise<Result<Role, AppError>> {
    try {
   ...
   * Update a role
   */
  async updateRole(roleId: number, input: Prisma.RoleUpdateInput): Promise<Result<Role, AppError>> {
    try {
